...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { country: @spot.country, genre: @spot.genre, image: @spot.image, name: @spot.name, post_comment: @spot.post_comment } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { country: @spot.country, genre: @spot.genre, image: @spot.image, name: @spot.name, post_comment: @spot.post_comment } }
